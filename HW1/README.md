...
![Linear B-field animation](animation.gif)

**Nonlinear material (steel_1010)**

![Nonlinear B-field animation](animation_nonlinear.gif)
...
![Comparison plot](nonlinear_comparison.png)

### Switched Excitation (Q4)
![Switched torque](switched_torque.png)

### B–H Curve (steel_1010)
![BH curve](bh_curve_steel1010.png)
